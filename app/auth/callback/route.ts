...
// Minimal port of old callback with project conventions.
function getBaseUrlAndLocale(request: Request) {
...
function buildRedirect(baseUrl: string, locale: string, path: string) {
