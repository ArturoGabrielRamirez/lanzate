// Componente DangerZone actualizado para usar la nueva lógica
...
export default function DangerZone({ userId, onStatusChange }: { userId: number; onStatusChange?: () => void }) {
    ...
    // ✅ HANDLERS usando las factory functions
    ...
    // ✅ RENDERIZADO CONDICIONAL basado en el estado actualizado
    ...
    return (
        <div className="space-y-6">
            {/* ✅ COUNTDOWN actualizado con nuevas props */}
