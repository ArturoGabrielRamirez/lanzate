    ...
    ({ title, logos, speed = 'normal', className, ...props }, ref) => {
        ...
        `}</style>
                ...
                <section
                    ...
                    aria-label={title}
                    className={cn(
                        'w-full text-foreground rounded-lg overflow-hidden',
                        className
                    )}
                    {...props}
                >
                    ...
                    >
                        ...
                        >
                            ...
                            {[...logos, ...logos].map((logo, index) => (
                                <div
                                    key={index}
                                    className="group relative h-24 w-40 shrink-0 flex items-center justify-center rounded-lg bg-card overflow-hidden shadow-md hover:drop-shadow-xl hover:shadow-lg transition-all duration-300 ease-in-out hover:-translate-y-2"
                                >
