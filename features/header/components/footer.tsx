            ...
            <div className="mx-auto container px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
                ...
                >
                    <nav className="flex gap-6">
                        <Link href="/terms-and-conditions" className="text-muted-foreground text-sm">Terms & Conditions</Link>
                        <Link href="/privacy-policy" className="text-muted-foreground text-sm">Privacy Policy</Link>
                        <Link href="/cookies" className="text-muted-foreground text-sm">Cookies</Link>
                    </nav>
