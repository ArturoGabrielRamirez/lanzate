...
function FloatingDock() {
    ...
    return (
        <motion.footer className="fixed bottom-0 w-full p-2 pb-2 z-50 xl:hidden container left-1/2 -translate-x-1/2">
            <motion.div className={cn("bg-primary/25 dark:bg-background/70 backdrop-blur-[4px] rounded-full py-1 px-2 flex items-center gap-2 border-t dark:border-t-foreground/20 border-b dark:border-b-background/90 border-b-primary/40 border-t-white/70 justify-between overflow-hidden transition-[padding,border,gap] mx-auto [box-shadow:0_1px_8px_4px_hsl(0_0%_0%_/_0.1)] drop-shadow-2xl drop-shadow-black/50", showSearch && "px-2 py-2 !border-primary/80 border-3 gap-1")} animate={{ paddingInline: showSearch ? "8px" : "12px ", width: showSearch ? "100%" : "fit-content", y: showDock ? 0 : 100 }}>
