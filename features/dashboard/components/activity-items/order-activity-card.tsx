...
function OrderActivityCard({ item }: Props) {
    return (
        <motion.div
            ...
            whileTap={{ scale: 0.98 }}
        >
            <Card className="py-2 md:py-4 space-y-3 transition-all bg-gradient-to-br from-primary/30 dark:from-primary/10 to-transparent border-white/5 backdrop-blur-xs hover:from-primary/20 hover:to-transparent hover:!shadow-2xl">
