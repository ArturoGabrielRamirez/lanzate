...
async function HeroSection() {
    ...
    return (
        <section className="flex flex-col md:grid md:grid-cols-[1fr_auto] md:gap-0 xl:gap-20 2xl:gap- min-h-dvh justify-center items-center md:items-end md:pb-12 lg:pb-20 relative pt-17 px-4 container mx-auto">
