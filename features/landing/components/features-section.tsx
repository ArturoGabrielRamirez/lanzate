                            ...
                            <Card className="relative col-span-full hover:drop-shadow-xl hover:-translate-y-1 transition-all overflow-hidden sm:col-span-3 lg:col-span-2">
                                <CardContent>
                                    ...
                                    <div className="relative z-10 space-y-2 text-center">
                                        ...
                                        <p className='text-sm text-muted-foreground'>Lanzate is available across all devices. You can manage your store anywhere!</p>
                                    </div>
                                </CardContent>
                            </Card>
                            <Card className="relative col-span-full hover:drop-shadow-xl hover:-translate-y-1 transition-all overflow-hidden sm:col-span-3 lg:col-span-2">
                                <CardContent className='flex flex-col grow'>
                                    ...
                                    <div className="relative z-10 space-y-2 text-center mt-auto">
                                        ...
                                        <p className='text-sm text-muted-foreground'>Get your own domain URL and publish your products with your own brand!</p>
                                    </div>
                                </CardContent>
                            </Card>
                            <Card className="relative col-span-full hover:drop-shadow-xl hover:-translate-y-1 transition-all overflow-hidden lg:col-span-3">
