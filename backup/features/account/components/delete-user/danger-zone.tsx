...
import { DangerZoneProps, UserDeletionStatus } from '@/features/account/types/types'
import {
...
const DangerZone = forwardRef<DangerZoneRef, DangerZoneProps>(
  ({ userId, onStatusChange }, ref) => {
    ...
    if (!deletionStatus.isDeletionRequested) {
      return (
        <div className="bg-gray-800 border border-red-500/30 rounded-lg p-6">
          <h3 className="text-red-400 font-semibold text-lg mb-4 flex gap-2 items-center">
