...
function ProductDetailForm({ product, slug }: ProductDetailFormProps) {
    ...
    return (
        <Card>
            ...
            <CardContent className="space-y-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                {/* Medios */}
                <div className="space-y-2">
                    <label className="text-sm font-medium">Imagen principal</label>
                    <div className="relative w-full max-w-sm aspect-video overflow-hidden rounded-lg border bg-secondary">
