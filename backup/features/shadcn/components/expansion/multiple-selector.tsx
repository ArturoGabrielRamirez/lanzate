...
import { Command, CommandGroup, CommandItem, CommandList } from '@/features/shadcn/components/ui/command';
    ...
    return (
      ...
      >
        ...
        <div className="relative">
          {open && (
            <CommandList
              className="relative top-1 z-10 w-full rounded-md border bg-popover text-popover-foreground shadow-md outline-none animate-in"
              onMouseLeave={() => {
